...
def _calculate_bond_yield(face_value, coupon_rate, years_to_maturity, current_price, payments_per_year):
    ...
    def bond_price_at_yield(yield_rate: float) -> float:
        """Calculate the price of a bond at a given yield."""
        pv_coupons = 0.0
    ...
    def bond_present_value(yield_rate: float) -> float:
        ...
        return bond_price_at_yield(yield_rate) - current_price
...
def _bond_price(face_value, coupon_rate, years_to_maturity, yield_to_maturity, payments_per_year):
    """Pure calculation: bond price from yield."""
    coupon_payment = (face_value * coupon_rate) / payments_per_year
    total_payments = int(years_to_maturity * payments_per_year)
...
def calculate_bond_price(payload: BondPriceRequest):
    """
